...
extern "C" void Java_com_example_ioconcise_MyService_jniSvmPredict(JNIEnv *env, jobject obj, jstring cmdIn){
...
extern "C" void Java_com_example_ioconcise_MyService_jniSvmScale(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
	debug("jniSvmPredict cmd = %s", cmd);
...
extern "C" void Java_com_example_ioconcise_MyService_processAudio(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
	debug("jniSvmPredict cmd = %s", cmd);
